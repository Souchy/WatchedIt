...
import { UserMediaDetails } from "src/core/Types";
...
export class MovieList {
	...
	// @bindable medias: Array<MediaUserData & { details: MediaType }> | null = null;
	@bindable medias: Array<UserMediaDetails> | null = null;
