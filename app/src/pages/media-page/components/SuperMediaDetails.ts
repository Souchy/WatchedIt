...
export interface ISuperMediaDetails<T extends Movie | TVShow> {
	mediaId: number;
	media: T;
...
export abstract class SuperMediaDetails<T extends Movie | TVShow> implements ISuperMediaDetails<T> {
